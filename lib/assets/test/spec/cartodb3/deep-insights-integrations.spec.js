...
describe('deep-insights-integrations', function () {
  beforeEach(function (done) {
    ...
    spyOn(DeepInsightsIntegrations.prototype, '_onAutoStyleChange');
  ...
  describe('when a new layer is created', function () {
    ...
    describe('when autoStyle is set/unset', function () {
      beforeEach(function () {
        this.model = this.widgetDefinitionsCollection.add({
          id: 'w-100',
          type: 'category',
      ...
      it('should detect autoStyle changes', function () {

        this.widgetModel = this.dashboard.getWidgets()[0];

        this.widgetModel.set('autoStyle', true);
        expect(DeepInsightsIntegrations.prototype._onAutoStyleChange).toHaveBeenCalled();
