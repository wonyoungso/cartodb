...
module.exports = CoreView.extend({
  ...
  _renderContextMenu: function () {
    var menuItems = [{
      ...
      val: 'rename-layer',
      action: this._editLayerName.bind(this)
    }, {
      label: function () {
        return this._isCollapsed() ? _t('editor.layers.options.expand') : _t('editor.layers.options.collapse');
      }.bind(this),
      val: 'collapse-expand-layer',
      action: this._collapseLayer.bind(this)
    }, {
