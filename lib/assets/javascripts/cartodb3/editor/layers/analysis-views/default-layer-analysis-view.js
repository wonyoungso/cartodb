...
module.exports = CoreView.extend({
  ...
  render: function () {
    ...
    var menuItems = [{
      label: _t('editor.layers.options.layer-from-node'),
      val: 'create-from-node'
    }, {
      label: _t('editor.layers.options.edit-analysis'),
      val: 'edit-analysis'
    }, {
      label: _t('editor.layers.options.delete-analysis'),
      val: 'delete-analysis'
    }];
